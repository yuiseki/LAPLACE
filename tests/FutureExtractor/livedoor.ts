...
const futureEventsLatestJsonFilePath =
  "public/data/news.livedoor.com/future_events/latest_events.json";
const now = new Date();
const today = now
  ...
  .split("/")
  .join("-");
const futureEventsTodayJsonFilePath = `public/data/news.livedoor.com/future_events/${today}_events.json`;
